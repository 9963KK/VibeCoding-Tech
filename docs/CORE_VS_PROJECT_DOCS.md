...
| 文档 | 职责 | 内容 |
|------|------|------|
| **Standards.md** | 入口与索引 | 文档导航、开发流程、使用规则 |
| **Project.md** | 架构与模块边界 | 技术栈、模块清单、功能索引 |
| **Feature-List.md** | 功能状态 SoT | 每个功能的描述 + TODO + 状态 |
| **Appendix.md** | 规范索引 | 编码规范、技术细节、用户偏好 |
...
所有 PROJECT-DOCS 必须在 `Standards.md` 中注册：
