...
3. 或者读取以下文件判断版本特征：
   - `docs/core/功能清单.md` 或 `docs/功能清单.md`
   - `docs/core/项目文档.md` 或 `docs/项目文档.md`
...
```bash
# 创建备份
cp docs/core/功能清单.md docs/core/功能清单.md.bak
cp docs/core/项目文档.md docs/core/项目文档.md.bak
```
...
💾 备份文件：
- docs/core/功能清单.md.bak
- docs/core/项目文档.md.bak
