...
### v2.0 (2026-01-09)
- **优化**：Links字典补全 Core 文档链接（L-910~L-913）
- **优化**：内部文档分为模板和 Core 文档两部分

### v1.0 (2026-01-09)
- **初始化**：创建附加材料模板
- **新增分类**：CS / API / DB / SEC / TEST / TD / DS / UM
- **新增条目**：
  - CS-001, CS-002, CS-003（编码规范基础条目）
  - API-001, API-002, API-003（API设计基础条目）
  - DB-001, DB-002, DB-003（数据库设计基础条目）
  - SEC-001, SEC-002, SEC-003（安全检查基础条目）
  - TEST-001, TEST-002, TEST-003（测试策略基础条目）
  - TD-001, TD-002（技术细节示例）
  - DS-001, DS-002（设计风格示例）
  - UM-20260109-001, UM-20260109-002（用户记忆示例）
- **Links字典**：添加30+个参考链接
